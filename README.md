...
# Requirements?
Really not much. I mean an x86/64 processor {until I port this to arm haha!} , a chipset that supports monitor-mode/packet-injection and some distro of linux that uses the apt package manager (kali/ubuntu/debian **__preferably Kali as it has drivers baked in__** ).Did I mention it needs python3? I mean it should be baked in depending on the os. 
# Usage?
