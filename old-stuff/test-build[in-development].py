...
time.sleep(0.5)
os.system("clear")
os.system("xterm $HOLD -title 'Installing any dependancies [python3]'  $TOPLEFTBIG -bg '#FFFFFF' -fg '#000000' $TOPLEFTBIG -bg '#FFFFFF' -fg '#000000' $TOPLEFTBIG -bg '#FFFFFF' -fg '#000000' -e apt install python3 -y")
while True:
	try:
		def mainScreen():
			print ("""
